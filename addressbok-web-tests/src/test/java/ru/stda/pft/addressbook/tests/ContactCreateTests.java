...
public class ContactCreateTests {
  ...
  public void testContactCreate() throws Exception {
    gotoContactAdiitionPage();
    fillContactForm(new ContactData("Евгения", "Алексеевна", "П", "jane",
            "Умник","Bee", "NY","11111", "22222", "33333",
            "44444", "email", "email2", "email3", "adf.ru","1","June","1980",
            "1","July","1980", "test", "sdgsdg", "5555555","hdf",
            /* null*/"https://w.forfun.com/fetch/35/3568329d72ef7092e7b421ab42961710.jpeg"));

    wd.findElement(By.xpath("//div[@id='content']/form/input[21]")).click();
    wd.findElement(By.id("header")).click();
    wd.findElement(By.linkText("home")).click();
    System.out.println ("Умник");
  ...
  private void fillContactForm(ContactData contactData) {
    ...
    wd.findElement(By.name("email2")).sendKeys(contactData.getEmail3());
...
/*    public void testUntitledTestCase() throws Exception {
  ...
  private void gotoContactAdiitionPage() {
